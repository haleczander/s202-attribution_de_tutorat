...
// private Scenario() {
// throw new UnsupportedOperationException("Utility class and cannot be
// instantiated");
// }
...
// * chaque étudiant a un nom, une moyenne, un niveau, un nombre d'absences et
// une
// * motivation.
...
// "+tutored+"\nTuteurs:\t "+tutors);
// System.out.println("\nDes différences d'arrondis à 0.001 près avec le rapport
